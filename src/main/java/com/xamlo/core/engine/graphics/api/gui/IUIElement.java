...
public interface IUIElement {
	...
	/**
	 * Рисует ли элемент свой контент строго в пределах собственной рамки: при true
	 * эффективный клип-прямоугольник пересекается с границами элемента и вышедший
	 * за край текст обрезаются шейдерным скисором.
	 */
	default boolean isContentClipped() {
		return false;
	}
