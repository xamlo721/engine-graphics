...
/**
 * OpenGL позволяет переопределить оператор сравнения, используемый в тесте глубины,
 * 
 * что дает нам тонкий контроль над тем, какие фрагменты стоит обработать, 
 * 
 * какие отбросить и в каких случаях буфер глубины будет обновлен. 
 * 
 * 
 * @author Satomi
 *
...
public class OpenGLDepth {
     ...
     * Оператор устанавливается через вызов функции glDepthFunc:
     * 
